...
Adds buttons to the right hand side of the statusbar to rename the current terminal or show terminals if hidden.
...
This extension was created before the terminals had a way to rename them other than using the command palette.
...
Show Label   | An alternative label for the show button.   | -             | String
